            ...
            l = {
                ...
                updateSticky: function() {
                    ...
                    a.header &&
                        KTUtil.hasClass(i, "card-sticky-on") &&
                            ((t =
                                a.options.sticky.position.top instanceof
                                Function
                                    ? parseInt(
                            ...
                            (e =
                                a.options.sticky.position.left instanceof
                                Function
                                    ? parseInt(
                            ...
                            (n =
                                a.options.sticky.position.right instanceof
                                Function
                                    ? parseInt(
                                    ...
                                    : parseInt(
                                          a.options.sticky.position.right
                                      )),
                            KTUtil.css(
                                a.header,
                                "z-index",
                ...
                remove: function() {
                    !1 !== l.eventTrigger("beforeRemove") &&
                        (KTUtil.remove(n), l.eventTrigger("afterRemove"));
                },
                ...
                init: function(t) {
                    (a.element = n),
                        ...
                        "class" == a.options.targetToggleMode
                            ? (a.state = KTUtil.hasClasses(
                                  a.target,
                                  a.targetState
                              )
                                  ? "on"
                                  : "off")
                            : (a.state = KTUtil.hasAttr(
                                  a.target,
                                  "data-" + a.targetState
                              )
                                  ? KTUtil.attr(
    ...
    (function(t) {
        ...
        (t.fn.KTDatatable = function(i) {
            if (0 !== t(this).length) {
                ...
                var l = {
                    ...
                    init: function(e) {
                        ...
                        var r = "";
                        return (
                            t(l.getOption("search.input")).on("keyup", function(
                                e
                            ) {
                                if (
                    ...
                    paging: function(e, n) {
                        var i = {
                            ...
                            init: function(e) {
                                (i.meta = e),
                                    ...
                                    i.meta.page > i.meta.pages &&
                                        (i.meta.page = i.meta.pages),
                                    (i.paginateEvent = l.getTablePrefix(
                                        "paging"
                                    )),
                            ...
                            populate: function() {
                                ...
                                var n = t("<ul/>").addClass(
                                    "datatable-pager-nav mb-5 mb-sm-0"
                                );
            ...
            (t.fn.KTDatatable.defaults = {
                ...
                editable: !1,
                columns: [],
                search: { onEnter: !1, input: null, delay: 1000, key: null },
                rows: {
                    callback: function() {},
                ...
                var n = {
                    ...
                    init: function() {
                        n.selectorEnabled() &&
                            ...
                            t(e).on("datatable-on-layout-updated", function(
                                a,
                                i
                            ) {
                            ...
                            t(e.tableBody)
                                ...
                                .click(function(i) {
                                    ...
                                    (l.selectedRows = n.selectedRows.filter(
                                        ...
                                        (l.unselectedRows = n.unselectedRows.filter(
                                            n.unique
                                        )),
...
var KTLayoutSearch = function() {
    var t,
        ...
        h = function() {
            if (d && s === a.value)
                return (
                    f(), KTUtil.addClass(t, p), g(), void KTUtil.scrollUpdate(i)
                );
            (s = a.value),
