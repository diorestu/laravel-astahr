                ...
                <div class="col-xl-3">
                    <div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-position: right top; background-size: 30% auto; background-image: url(https://preview.keenthemes.com/metronic/theme/html/demo7/dist/assets/media/svg/shapes/abstract-1.svg)">
                        <div class="card-body">
                            ...
                            <br>
                            <a class="text-danger font-weight-bolder font-size-h1 pr-1">{{ $projects_count }}</a>
                ...
                <div class="col-xl-3">
                    <div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-position: right top; background-size: 30% auto; background-image: url(https://preview.keenthemes.com/metronic/theme/html/demo7/dist/assets/media/svg/shapes/abstract-2.svg)">
                        <div class="card-body">
                            ...
                            <br>
                            <a class="text-dark-75 font-weight-bolder font-size-h1 pr-1">{{ $staffs_count }}</a>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 py-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Project Kelolaan PT. Asta Nadi Karya Utama</span>
                            </h3>
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-light-info font-weight-bolder font-size-sm mr-3">Cetak</a>
                                <a href="#" class="btn btn-light-danger font-weight-bolder font-size-sm">Lihat Data</a>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                                        ...
                                        <thead>
                                            <tr class=" text-uppercase">
                                                <th style="min-width: 250px" class="pl-7">
                                                    <span class="text-left text-dark-75">nama Pekerjaan</span>
                                                </th>
                                                
                                                <th style="min-width: 100px" class="text-center">PIC</th>
                                                <th style="min-width: 100px" class="text-center">Nilai</th>
                                            ...
                                            <tr>
                                                <td class="pl-0 py-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Gapura Angkasa</a>
                                                            <span class="text-muted font-weight-bold d-block">Cab. Surabaya</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Sigit Setyawan</span>
                                                    <span class="text-muted font-weight-bold">Koordinator</span>
                                                </td>
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Rp. 23,000,000,000</span>
                                                    <span class="text-muted font-weight-bold">3 Tahun</span>
                                                </td>
                                                <td class="pr-0 text-center">
                                                    <a href="#" class="btn btn-light-success font-weight-bolder font-size-sm">Detail</a>
                                                </td>
                                            </tr>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                                ...
                                <div class="d-flex flex-column flex-grow-1 mr-2">
                                    <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">1.0{{ $invoice }}/ASTA/INV/{{ $month->month }}/{{ date('Y') }}</a>
                                    <span class="text-muted font-weight-bold">Nomor Invoice ke {{ $invoice }}</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-9 bg-light-success rounded p-5">
                                ...
                                @php
                                    $month = Carbon\Carbon::now();
                                    if ($invoice != null) {
                                        $invoices = '1.0' . $invoice . '/ASTA/INV/' . $month->month . '/' . date('Y');
                                        $urutan = $invoice;
                                        
                                    }else{
                                        $invoices = "Belum Ada Nomor Surat Terbuat";
                                        $urutan = "-";
                                    }
                                @endphp
                                <div class="d-flex flex-column flex-grow-1 mr-2">
                                    <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-h5 mb-1">{{ $invoices }}</a>
                                    <span class="text-muted">Nomor Invoice ke {{ $urutan }}</span>
                                </div>
                                <span class="font-weight-bolder text-warning py-1 font-size-lg">
                                    <i class="flaticon2-arrow"></i>
                                </span>
