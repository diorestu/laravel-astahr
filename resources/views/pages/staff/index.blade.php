            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div data-aos="zoom-in" class="d-flex align-items-baseline mr-5">
                    <ul class="breadcrumb breadcrumb-transparent font-weight-200 breadcrumb-dot p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Data Karyawan</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header border-0">
                            <h3 class="card-title font-weight-bolder text-dark">Data Personil SDM</h3>
                            <div class="card-toolbar">
                                <a href="{{ route('staff.create') }}" type="button" class="btn btn-sm btn-primary mr-2">
                                    <span class="navi-icon">
                                        <i class="flaticon2-plus icon-sm"></i>
                                    </span>
                                    Tambah Data
                                </a>
                                <a href="{{ route('staff-print') }}" target="_blank" class="btn btn-sm btn-primary mr-2">
                                    <span class="navi-icon">
                                        <i class="flaticon2-plus icon-sm"></i>
                                    </span>
                                    Tambah Data
    ...
    <script type="text/javascript">
        ...
        var datatable = $('#crudTable').DataTable({
            ...
            columns: [
                ...
                { data: 'position.pos', name: 'position.pos' },
                {
                    data: 'action',
                    name: 'action',
                    orderable: false,
