                ...
                <div class="col-lg-12">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header border-0">
                            <h3 class="card-title font-weight-bolder text-dark">Data Karyawan</h3>
                            <div class="card-toolbar">
                                <a href="{{ route('staff.create') }}" type="button" class="btn btn-sm btn-shadow btn-success mr-2">Tambah Data</a>
