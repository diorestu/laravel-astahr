...
class KwitansiController extends Controller
{
                        ...
                        <div class="btn-group">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="action' .  $item->id . '">
                                    <a class="dropdown-item" href="' . route('kwitansi.edit', $item->id) . '">
                                        Sunting
                                    </a>
                                    <form action="' . route('kwitansi.destroy', $item->id) . '" method="POST">
    ...
    public function create()
    {
        ...
        $noAkhir = Kwitansi::whereMonth('created_at', date('m'))->max('urut');
        ...
        return view('pages.kwitansi.create', [
    ...
    public function store(Request $request)
    {
        ...
        $data['kategori'] = "2.2$nomorSurat/ASTA/KWI/$month/$year";


        Letter::create($data);

        // Alert::alert('Berhasil', 'Menambahkan data invoice', 'Success');
        Alert::alert('Berhasil', 'Tambah Kwitansi Berhasil', 'success')->autoClose(2000);
