            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div data-aos="zoom-in" class="d-flex align-items-baseline mr-5">
                    <ul class="breadcrumb breadcrumb-transparent font-weight-200 breadcrumb-dot p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Data Surat Eksternal</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header border-0">
                            <h3 class="card-title font-weight-bolder text-dark">Data Surat Eksternal</h3>
                            <div class="card-toolbar">
                                <a href="{{ route('kwitansi.create') }}" type="button" class="btn btn-sm btn-shadow btn-success mr-2">
